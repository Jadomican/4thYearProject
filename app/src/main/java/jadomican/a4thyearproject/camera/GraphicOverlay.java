...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    /**
     * Base class for a custom graphics object to be rendered within the graphic overlay. Must be
     * subclassed and implement the draw(Canvas) method to define the graphic element. The add()
     * method is used to add instances to the overlay
     */
